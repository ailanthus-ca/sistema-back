...
<html lang="en">
    ...
    <script>
      !(function (e) {
        function r(r) {
          for (
            var n, i, a = r[0], c = r[1], l = r[2], f = 0, p = [];
            f < a.length;
            f++
          )
            (i = a[f]),
        ...
        var a = (this.webpackJsonpsisreact = this.webpackJsonpsisreact || []),
          c = a.push.bind(a);
        (a.push = r), (a = a.slice());
    ...
    <script src="/static/js/2.1d31109d.chunk.js"></script>
    <script src="/static/js/main.aa486739.chunk.js"></script>
