...
$sql = $con->query("SELECT * from tmp_fact_prod where id_tmp = '$id'")or die($con->error);
    ...
    <table>
        ...
        <tr>
            ...
            <td class="col-xs-1" class='text-center'>
                <a class='btn btn-info' onclick="editarProducto('<?php echo $codigo; ?>', '<?php echo $stock; ?>', '<?php echo $tipo; ?>')">Aplicar</a>
            </td>
        </tr>
    </table>
</div>
