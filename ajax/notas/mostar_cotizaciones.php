    ...
    if ($numrows > 0) {
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            ?><tr>
                        ...
                        <td class='text-center'><a class='btn btn-info' onclick="cargaCotizacion('<?php echo $cod_cotizacion ?>', '<?php echo $nom_cliente ?>', '<?php echo $tel_cliente ?>', '<?php echo $dir_cliente ?>', '<?php echo $codigo_cliente ?>', '<?php echo $forma_pago ?>', '<?php echo $tem_entrega ?>', '<?php echo $valides ?>', '<?php echo $nota ?>')"><i class="glyphicon glyphicon-plus"></i></a></td>
                    </tr>
            <?php
        }
        ?>
