...
if (isset($_GET['id'])) {
    ...
    if ($action == 'eliminar') {
        $del1 = "update departamento set estatus=0 where codigo='" . $id . "'";
        $mensaje = 'Departameto eliminado exitosamente';
    } elseif ($action == 'activar') {
        $del1 = "update departamento set estatus=1 where codigo='" . $id . "'";
        $mensaje = 'Departamento activado exitosamente';
    }
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="#" class='btn btn-default' data-toggle="modal" data-target="#editar_departamento" title="Ver/Editar" onclick="ver_departamento('<?php echo $codigo; ?>');"><i class="glyphicon glyphicon-edit"></i></a>
