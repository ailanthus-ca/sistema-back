...
if (isset($_GET['id'])) {
    ...
    if ($action == 'eliminar') {
        $del1 = "DELETE from moneda where id='" . $id . "'";
            ...
            <table class="table">
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="#" class='btn btn-default' data-toggle="modal" data-target="#editar_unidad" title="Ver/Editar" onclick="ver_unidad('<?php echo $codigo; ?>');"><i class="glyphicon glyphicon-edit"></i></a>
