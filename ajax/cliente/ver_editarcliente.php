...
?>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="correo_<?php echo $codigo ?>" name="correo" value="<?php echo $correo ?>">
		</div>
	  </div>
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-8">
		  <input type="text" class="form-control" id="direccion_<?php echo $codigo ?>" name="tipo_contribuyente" value="<?php echo $tipo_contribuyente ?>">
		</div>
	  </div>	  
