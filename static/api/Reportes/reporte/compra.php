...
<table  cellspacing="0">
    <thead>
        <tr>
            ...
            <th class="col-5" style="text-align: left">Proveedor</th>
            <th class="col-2" style="text-align: center">Numero Doc.</th>
    ...
    <tbody>
        ...
        foreach ($data['compras'] as $c) {
            ...
            <tr>
                ...
                <td class="col-5" style="text-align: left"><?php echo $c['nombre'] ?></td>
                <td class="col-2" style="text-align: center"><?php
                    if ($c['cod_documento'] !== '')
