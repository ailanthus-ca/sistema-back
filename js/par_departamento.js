...
function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'ajax/parametros/departamento/buscar_departamento.php?action=ajax&page='+page+'&q='+q,
...
function eliminar (id){
    ...
    if (confirm("¿Realmente deseas eliminar el registro?")){
        $.ajax({
            type: "GET",
            url: "ajax/parametros/departamento/buscar_departamento.php?action=eliminar",
            data: "id="+id,"q":q,
            beforeSend: function(objeto){
...
function ver_departamento(id){
    $("#carga").fadeIn('slow');
    $.ajax({
        url:"ajax/parametros/departamento/ver_departamento.php?id=" + id,
        beforeSend: function(objeto){
...
$( "#form_editar_departamento" ).submit(function( event ) {
    $('#guardar_cambios').attr("disabled", true);

    var parametros = $(this).serialize();
    $.ajax({
        type: "POST",
        url: "ajax/parametros/departamento/editar_departamento.php",
        data: parametros,
        beforeSend: function(objeto){
...
$( "#form_departamento" ).submit(function( event ) {
    ...
    $.ajax({
        type: "POST",
        url: "ajax/parametros/departamento/nuevo_departamento.php",
        data: parametros,
        beforeSend: function(objeto){
            $("#resultados_ajax").html("Mensaje: Cargando...");
        },
