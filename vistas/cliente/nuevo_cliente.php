                          ...
                          <div class="panel-body">
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <input id="codigo" name="codigo" type="text" class="form-control" placeholder="RIF/Cedula"  required />
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                                           <textarea id="nombre" name="nombre" class="form-control" required placeholder="Ingrese un nombre"></textarea>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">    
                              ...
                              <div class="row">
                                ...
                                <div class="form-group">
                                  ...
                                  <input id="tipo_contribuyente" name="tipo_contribuyente" type="radio"  value="ordinario" onclick="option(this.value)" required />Ordinario
                                  <input id="tipo_contribuyente" name="tipo_contribuyente" type="radio"  value="especial" onclick="option(this.value)" required /> especial
                                  <input type="number" style="width: 65%" name="retencion" id="retencion" class="form-control" placeholder="Retencion %" max="100" readonly>
                                </div>
                                </div>                                
                              </div>
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-3"> 
                                    <button name="submit" id="guardar" type="submit" class="btn btn-primary"> <i class="fa fa-check-square"></i> Guardar</button>
                                  </div>
                              </div>
                              </div>
                             </div>
...
<script type="text/javascript" src="./js/nuevo_cliente.js"></script>
