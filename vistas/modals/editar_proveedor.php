	<!-- Modal -->
<div class="modal fade bs-example-modal-lg" id="editar_proveedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form class="form-horizontal" method="post" name="form_editar_proveedor" id="form_editar_proveedor">
	  ...
	  <div class="modal-footer">
		  <button type="submit" class="btn btn-primary" name="guardar_cambios" id="guardar_cambios"> <i class="glyphicon glyphicon-floppy-saved"></i>Guardar datos</button>
	  	  <button id="btn_modalEditarProveedor" type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>	  </div>
	  </form>
	</div>
  </div>
</div>
