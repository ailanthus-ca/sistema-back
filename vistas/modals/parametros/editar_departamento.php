...
?>
<!-- Modal -->
<div class="modal fade bs-example-modal-lg" id="editar_departamento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" name="form_editar_departamento" id="form_editar_departamento">
