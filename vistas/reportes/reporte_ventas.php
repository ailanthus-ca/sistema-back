...
<div class="col-md-10 col-md-offset-1">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4><i class='glyphicon glyphicon-list-alt'></i> Reporte de ventas </h4>
        </div>
        <div class="panel-body">
            <div class="form-horizontal" role="form" id="form_reporte_ventas">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            <label  class="col-md-4"><input type="radio" name="tipo" id="tipo" value="hoy" onclick="option(this.value);" selected> Hoy</label>
                        </div>
                        <br>
                        <div class="row">
                ...
                <div class="col-md-12">
                    <div class="pull-right">
                        ...
                        <button id="guardar_ajuste" class="btn btn-default" onclick="reporte_ventas();">
    ...
    <div class="col-md-12"><h4>Resumen de ventas por año</h4></div>
    <br><br>
    <div class="col-md-3">
...
<script type="text/javascript" src="./js/graficar_ventas.js"></script>
